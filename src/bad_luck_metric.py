...
def evaluate_metric(id_val, year_val, s2_val, swid_val):
    ...
    #add normalized percentages to list
    ptiles = []
    for entry in metrics:
        ...
        ptiles.append(' '.join([entry[0], entry[1], 'is in the', out_ptile, 'percentile of bad luck.']))
